...
learn = vision_learner(dls, resnet34, metrics=error_rate, config=cnn_config(bn_final=True))
...
learn = vision_learner(dls, resnet34, metrics=error_rate, config=cnn_config(bn_final=True)).load('352')
